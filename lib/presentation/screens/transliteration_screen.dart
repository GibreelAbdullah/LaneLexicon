                ...
                TableRow(
                  children: [
                    Padding(
                      ...
                      child: Text(latin, style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: cs.onSurface)),
                    ),
                    Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 10),
                      child: Text(arabic, style: TextStyle(fontSize: 22, color: cs.onSurface), textDirection: TextDirection.rtl),
                    ),
                  ],
                ),
            ],
